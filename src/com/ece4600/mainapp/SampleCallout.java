...
public class SampleCallout extends RelativeLayout {
	...
	public SampleCallout( Context context, double x_pos ,double  y_pos ) {
		...
		titleView.setText( "User Current Location" );
		...
		subTitleView.setText( "x positionO: " + x_pos + "y position: " + y_pos );
